...
import 'package:test_store/MainScreens/OrderPageScreen.dart';
                    ...
                    child: ListTile(
                      onTap: (){    Navigator.push(context,
                          MaterialPageRoute(builder: (BuildContext context) {
                            return OrderPageScreen(index: index,);
                          }));},
    ...
    if (context.read(generalmanagment).currentOrderPage <=
      ...
      try {
        await portal.requestUserOrders(userToken!, id.toString(),
            context.read(generalmanagment).currentOrderPage, context,false);
      } catch (e) {
        print(e);
      }
    }
